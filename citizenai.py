...
Original file is located at
    https://colab.research.google.com/drive/1RBtk41wCdL43CzeuzHM7Dn6x2TtkAkD6
"""
...
def citizen_interaction(query):
    prompt = f"As a government assistent,provide accurate and helpful information about the following citizen query related to public services, government policies, or civic issues:\n\nQuery:{query}\nResponse:"
    return generate_response(prompt, max_length=1000)
        ...
        with gr.TabItem("City Analysis"):
            with gr.Row():
                with gr.Column():
                    ...
                    ananlyze_btn = gr.Button("Analyze City")

                with gr.Column():
                    city_output = gr.Textbox(label="City Analysis(Crime Inex & Accidents)", lines=15)

            ananlyze_btn.click(city_analysis, inputs=city_input, outputs=city_output)
